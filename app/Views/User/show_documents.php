            ...
            <div id="collapse<?=$category['id_category']?>" class="accordion-collapse collapse" aria-labelledby="heading<?=$category['id_category']?>" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <div class="row">
                        ...
                        <?php if ($category['id_category']== $category['id_category']) : ?>
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-image d-flex justify-content-center align-items-center p-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="#F40F02" class="bi bi-file-pdf" viewBox="0 0 16 16" class="card-img-top">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="<?=base_url('documents/download/'.$document['id_document'])?>" class="btn btn-primary">Descargar</a>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
